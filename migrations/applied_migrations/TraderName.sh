...
echo "GET        /traderName                        controllers.TraderNameController.onPageLoad(mode: Mode = NormalMode)" >> ../conf/app.routes
echo "POST       /traderName                        controllers.TraderNameController.onSubmit(mode: Mode = NormalMode)" >> ../conf/app.routes

echo "GET        /changeTraderName                  controllers.TraderNameController.onPageLoad(mode: Mode = CheckMode)" >> ../conf/app.routes
echo "POST       /changeTraderName                  controllers.TraderNameController.onSubmit(mode: Mode = CheckMode)" >> ../conf/app.routes
...
echo "traderName.error.length = TraderName must be 100 characters or less" >> ../conf/messages.en
...
awk '/class CheckYourAnswersHelper/ {\
     ...
     print "            href               = routes.TraderNameController.onPageLoad(CheckMode).url,";\
