...
echo "GET        /authorisedLocation                        controllers.AuthorisedLocationController.onPageLoad(mode: Mode = NormalMode)" >> ../conf/app.routes
echo "POST       /authorisedLocation                        controllers.AuthorisedLocationController.onSubmit(mode: Mode = NormalMode)" >> ../conf/app.routes

echo "GET        /changeAuthorisedLocation                  controllers.AuthorisedLocationController.onPageLoad(mode: Mode = CheckMode)" >> ../conf/app.routes
echo "POST       /changeAuthorisedLocation                  controllers.AuthorisedLocationController.onSubmit(mode: Mode = CheckMode)" >> ../conf/app.routes
...
echo "authorisedLocation.error.length = AuthorisedLocation must be 50 characters or less" >> ../conf/messages.en
...
awk '/class CheckYourAnswersHelper/ {\
     ...
     print "            href               = routes.AuthorisedLocationController.onPageLoad(CheckMode).url,";\
