...
echo "GET        /customsSubPlace                        controllers.CustomsSubPlaceController.onPageLoad(mode: Mode = NormalMode)" >> ../conf/app.routes
echo "POST       /customsSubPlace                        controllers.CustomsSubPlaceController.onSubmit(mode: Mode = NormalMode)" >> ../conf/app.routes

echo "GET        /changeCustomsSubPlace                  controllers.CustomsSubPlaceController.onPageLoad(mode: Mode = CheckMode)" >> ../conf/app.routes
echo "POST       /changeCustomsSubPlace                  controllers.CustomsSubPlaceController.onSubmit(mode: Mode = CheckMode)" >> ../conf/app.routes
...
echo "customsSubPlace.error.length = CustomsSubPlace must be 100 characters or less" >> ../conf/messages.en
...
awk '/class CheckYourAnswersHelper/ {\
     ...
     print "            href               = routes.CustomsSubPlaceController.onPageLoad(CheckMode).url,";\
