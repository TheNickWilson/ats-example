...
class TraderNameControllerSpec extends SpecBase with MockitoSugar with NunjucksSupport with JsonMatchers {
  ...
  lazy val traderNameRoute = routes.TraderNameController.onPageLoad(NormalMode).url
  ...
  "TraderName Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(TraderNamePage, "answer").success.value
