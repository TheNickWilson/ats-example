...
class AuthorisedLocationControllerSpec extends SpecBase with MockitoSugar with NunjucksSupport with JsonMatchers {
  ...
  lazy val authorisedLocationRoute = routes.AuthorisedLocationController.onPageLoad(NormalMode).url
  ...
  "AuthorisedLocation Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(AuthorisedLocationPage, "answer").success.value
